...
const spintax = {
    metaDesc: [
        "Highest rated {service} company in Boca Raton. Tropishine delivers flawless, eco-friendly results.",
        "Looking for professional {service} in Boca Raton? Tropishine offers premium quality and guaranteed satisfaction.",
        "Top-tier {service} experts in Boca Raton. Trusted by locals for meticulous, reliable, and green cleaning.",
        "Boca Raton's premier choice for {service}. We specialize in deep, transformative cleaning solutions.",
        "Experience 5-star {service} in Boca Raton. Tropishine Cleaning ensures your property shines like new.",
        "Affordable, elite {service} in Boca Raton. Fully licensed, vetted professionals ready to transform your space.",
        "Need thorough {service} in Boca Raton? Tropishine guarantees spotless results every single time."
    ],
    heroBadges: [
        "{service} Specialists",
    ...
    intros: [
        "Welcome to Tropishine, Boca Raton's leading provider of {service}.",
        "Looking for the best {service} in Boca Raton? You've found the right team.",
        "Tropishine offers premium {service} for homes and businesses throughout Boca Raton.",
        "Experience the highest standard of {service} in Boca Raton with Tropishine.",
        "When it comes to top-rated {service} in Boca Raton, Tropishine Cleaning is the absolute standard.",
        "Elevate your environment with Boca Raton's unrivaled {service} specialists at Tropishine.",
        "Your search for meticulous, highly-rated {service} in Boca Raton ends here with Tropishine.",
        "Discover exactly why local residents and businesses consistently choose Tropishine for their {service} needs in Boca Raton."
    ],
    middles: [
        "Licensed, insured, and deeply committed to Boca Raton property standards for every {service}.",
        "Your trusted {service} partner in Boca Raton. We don't cut corners, we clean them.",
        "Delivering {service} excellence that Boca Raton residents and businesses rely on.",
    ...
    bentoDesc1: [
        ...
        "We understand the unique needs of Boca Raton properties and tailor our approach to deliver unmatched results.",
    ...
    bentoDesc3: [
        "Punctual execution for your {service} right when you need it in Boca Raton.",
    ...
    outros: [
        "Ready to transform your space? Contact us today to schedule your {service} in Boca Raton.",
        "Don't settle for less. Give your property the care it deserves with our professional {service}.",
        "Reach out now for a free estimate and discover why Boca Raton trusts Tropishine.",
        "Book your appointment today and experience the Tropishine difference firsthand.",
        "Call us or book online instantly to secure your preferred {service} slot in Boca Raton."
    ],
    faqs: [
        [
            {q: "Why choose Tropishine for {service} in Boca Raton?", a: "Tropishine offers top-tier {service} with highly trained professionals and eco-friendly solutions tailored to Boca Raton properties."},
            ...
            {q: "How do I schedule a {service}?", a: "You can easily schedule your {service} by calling our Boca Raton hotline or filling out an online request form. We offer flexible scheduling to meet your needs."}
        ],
        [
            {q: "What makes your {service} different?", a: "Our meticulous attention to detail and commitment to using advanced, eco-friendly cleaning technology sets our {service} apart in the Boca Raton area."},
...
services.forEach(service => {
    ...
    const titleStr = `${service.title} in Boca Raton | Tropishine Cleaning`;
    ...
    <section class="relative pt-8 md:pt-32 pb-24 md:pt-48 md:pb-36 overflow-hidden bg-zinc-950 min-h-[75vh] flex items-center">
        ...
        <div class="absolute inset-0 z-0" data-aos="zoom-out" data-aos-duration="2500">
            <img src="../${service.img}" alt="${service.title} in Boca Raton" class="w-full h-full object-cover opacity-[0.8] mix-blend-overlay">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10 w-full text-center">
            ...
            <h1 class="text-5xl md:text-7xl lg:text-8xl font-black text-white tracking-tighter mb-6 leading-tight" data-aos="fade-up" data-aos-delay="100">
                ${service.title} <br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-sky-200 to-sky-400 bg-300% animate-gradient">Boca Raton</span>
            </h1>
    ...
    <section id="details" class="py-6 md:py-24 md:py-32 bg-slate-50 relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto px-6 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto mb-4 md:mb-20" data-aos="fade-up">
                <h2 class="text-4xl md:text-5xl font-black text-zinc-900 mb-6">${service.title} in Boca Raton</h2>
            ...
            <div class="mb-24">
                <div class="text-center mb-16" data-aos="fade-up">
                    <h2 class="text-4xl font-black text-zinc-900 mb-4">Our Boca Raton Process</h2>
                ...
                <div class="grid md:grid-cols-3 gap-8 relative">
                    ...
                    <div class="text-center group relative z-10" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p class="text-zinc-600 text-sm leading-relaxed">Our trained Boca Raton specialists arrive fully equipped to deliver pristine results.</p>
                    </div>
            ...
            <div class="bg-zinc-900 rounded-3xl p-10 md:p-16 text-center shadow-2xl relative overflow-hidden" data-aos="zoom-in" data-tilt data-tilt-max="3" data-tilt-speed="600" data-tilt-perspective="1000" data-tilt-glare="true" data-tilt-max-glare="0.1">
                ...
                <h2 class="text-3xl md:text-5xl font-black text-white mb-6 relative z-10">Experience the Best in Boca Raton</h2>
            ...
            <div class="mt-24 max-w-5xl mx-auto" data-aos="fade-up">
                <div class="text-center mb-10">
                    ...
                    <p class="text-zinc-500 font-medium">Proudly delivering premium ${service.title} throughout Boca Raton and surrounding neighborhoods.</p>
                </div>
