...
const spintax = {
    about: {
        meta: [
            "Learn about Tropishine Cleaning's mission, values, and dedication to excellence.",
            "Discover the Tropishine difference. We are committed to premium quality and customer satisfaction.",
            "Our story: Providing top-tier, eco-friendly cleaning services tailored to your exact needs.",
            "Your trusted local professionals. We deliver uncompromising cleanliness to every client.",
            "Find out why locals trust Tropishine. Fully licensed, insured, and verified experts."
        ],
        heroBadge: ["Our Story", "Who We Are", "The Tropishine Standard", "Our Mission", "About Us"],
        heroTitle: [
            ...
            `The Tropishine <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-sky-200 to-sky-400 bg-300% animate-gradient">Difference</span>`,
            `Our Commitment To <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-sky-200 to-sky-400 bg-300% animate-gradient">Excellence</span>`
        ],
        heroDesc: [
            "We are more than a cleaning service. We are a dedicated team committed to creating pristine, healthy environments.",
            "Delivering unmatched cleanliness and peace of mind through rigorous standards and eco-friendly practices.",
            "Built on trust and excellence. We transform spaces so you can focus on what matters most.",
            "Providing white-glove service from start to finish, backed by a 100% satisfaction guarantee."
        ],
        missionTitle: ["Our Mission", "Our Primary Goal", "Our Focus", "Our Core Objective"],
        missionDesc: [
            "To provide unparalleled cleaning solutions that enhance the quality of life and productivity for our clients, prioritizing eco-friendly methods and uncompromised quality.",
            "To deliver spotless, transformative results while safeguarding the health and safety of our community through green initiatives.",
            "To set the highest standard of cleanliness, combining modern techniques with traditional dedication for unmatched client satisfaction."
        ],
        visionTitle: ["Our Vision", "Our Future", "Looking Ahead"],
        visionDesc: [
            "To be the undisputed standard of excellence in the cleaning industry, continuously innovating our methods while maintaining the personalized, original quality our clients trust.",
            "To redefine the professional cleaning experience by blending cutting-edge eco-friendly technology with elite, 5-star customer service.",
            "To build lasting relationships based on trust, reliability, and transformative results that speak for themselves."
        ]
    },
    gallery: {
        meta: [
            "View the stunning results of Tropishine Cleaning's premium services in our project gallery.",
            "Browse our extensive portfolio of transformations. Unmatched quality, visible in every detail.",
            "See the Tropishine difference for yourself. High-definition gallery of completed projects.",
            "Spotless spaces achieved. Look through our visual proof of elite cleaning solutions.",
            "Explore our gallery and see why we are the top-rated cleaning professionals."
        ],
        heroBadge: ["Visual Proof", "Our Work", "Project Gallery", "Transformations"],
        heroTitle: [
            ...
            `Visual <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-sky-200 to-sky-400 bg-300% animate-gradient">Transformations</span>`,
            `Spotless <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-sky-200 to-sky-400 bg-300% animate-gradient">Portfolios</span>`
        ],
        heroDesc: [
            "Browse through our portfolio of transformations. Unmatched quality, visible in every detail.",
            "Our results speak for themselves. Witness the unparalleled standard of a Tropishine finish.",
            "Explore our latest projects showcasing our commitment to pristine living environments.",
            "From deep cleaning to regular maintenance, view the level of detail we provide."
        ]
    },
    blog: {
        meta: [
            "Expert tips, news, and insights from the Tropishine professionals.",
            "Read our latest articles on eco-friendly cleaning, home maintenance, and industry news.",
            "Discover cleaning hacks, detailed guides, and updates on our premium services.",
            "Your source for professional cleaning insights and proven strategies to maintain a healthy home.",
            "Stay informed with the Tropishine Journal. Professional advice for a spotless life."
        ],
        heroBadge: ["Insights & News", "The Journal", "Cleaning Tips", "Expert Advice", "Our Blog"],
        heroTitle: [
            ...
            `Expert <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-sky-200 to-sky-400 bg-300% animate-gradient">Insights</span>`,
            `Cleaning <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-sky-200 to-sky-400 bg-300% animate-gradient">Knowledge</span>`
        ],
        heroDesc: [
            "Expert advice, industry insights, and the latest news from South Florida's premier cleaning team.",
            "Your definitive guide to maintaining beautiful, healthy environments year-round.",
            "Dive deep into the strategies and eco-friendly techniques used by the professionals.",
            "Stay up-to-date with our latest commercial and residential maintenance tips."
        ]
    }
};
...
const pages = [
    {
        ...
        slug: "about-us",
        title: "About Us",
        desc: spintax.about.meta[getRandomInt(spintax.about.meta.length)],
        heroImg: "images/office cleaning.JPG",
        buildBody: () => {
            return buildV3Hero(
                spintax.about.heroBadge[getRandomInt(spintax.about.heroBadge.length)],
                spintax.about.heroTitle[getRandomInt(spintax.about.heroTitle.length)],
                spintax.about.heroDesc[getRandomInt(spintax.about.heroDesc.length)],
    ...
    },
    {
        ...
        slug: "gallery",
        title: "Our Gallery",
        desc: spintax.gallery.meta[getRandomInt(spintax.gallery.meta.length)],
        ...
        buildBody: () => {
            ...
            return buildV3Hero(
                spintax.gallery.heroBadge[getRandomInt(spintax.gallery.heroBadge.length)],
                spintax.gallery.heroTitle[getRandomInt(spintax.gallery.heroTitle.length)],
                spintax.gallery.heroDesc[getRandomInt(spintax.gallery.heroDesc.length)],
    ...
    },
    {
        ...
        desc: spintax.blog.meta[getRandomInt(spintax.blog.meta.length)],
        ...
        buildBody: () => {
            ...
            return buildV3Hero(
                spintax.blog.heroBadge[getRandomInt(spintax.blog.heroBadge.length)],
                spintax.blog.heroTitle[getRandomInt(spintax.blog.heroTitle.length)],
                spintax.blog.heroDesc[getRandomInt(spintax.blog.heroDesc.length)],
...
// Generate Pages
pages.forEach(page => {
    const folderPath = path.join(__dirname, page.slug);
    ...
    pageHtml = pageHtml.replace(/<meta name="description" content=".*?">/s, `<meta name="description" content="${page.desc}">`);
    
    // Inject correct UNIQUE Canonical SEO tag
    pageHtml = pageHtml.replace(/<link rel="canonical" href="[^"]*" \/>/, `<link rel="canonical" href="https://www.tropishinecleaning.com/${page.slug}/" />`);
    
    // Inject Body, then lowerPage
    pageHtml += page.buildBody() + lowerPage;
